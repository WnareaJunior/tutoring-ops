...
# (Basic gives queues only). Oracle is NOT provisioned -- it stays on the WSL
# box and the API reaches it over a tunnel. Oracle in Azure costs real money
# and would not make the resume line any more true.
# =============================================================================
set -euo pipefail
